...
<body>
	...
	1-2-3-4-2-3-4-2-3-4  2번이 참일때까지 반복
...
--%>
	...
	// map, list? 
	// map : 순차적으로 접근이 아닌, 특정 키에의해 원하는 값을 확인하고 싶을 때
	...
	<h3>url 작성</h3>
	<a href="<c:url value="/registUser2"/>">사용자 등록</a><br>
	<a href="${cp }/registUser2">사용자 등록</a><br>	
	var 속성을 적용하지 않은 경우 : 태그를 작성한 곳에 출력<c:url value="/registUser2" var="url"/><br>
	var 속성을 적용한 경우 : var 속성으로 저장만 된다(el을 통해 활용)<c:url value="//registUser2" var="url"></c:url>
	${url }
