...
<body>
	...
	date fmt full : <fmt:formatDate value="${date }" type="date" dateStyle="full"/><br>
	date fmt medium : <fmt:formatDate value="${date }" type="date" dateStyle="medium"/><br>
	date fmt short : <fmt:formatDate value="${date }" type="date" dateStyle="short"/><br>
